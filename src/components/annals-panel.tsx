 ...
 * and event nodes threaded down through the Ages of the World. The lineages of
 * the Houses live apart, on the reading desk — see the LineagePanel.
 */
...
export function AnnalsPanel({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <View style={[StyleSheet.absoluteFill, { pointerEvents: open ? 'auto' : 'none' }]}>
      <AnimatedPressable style={[styles.backdrop, backdropStyle]} onPress={onClose} accessibilityLabel="Close the annals" />
